...
const RightSidebar = () => {
  ...
  // Gat all the images from the messages and set them to state
  useEffect(()=>{
    setMsgImages(
  ...
  return selectedUser && (
    <div className={`bg-[#818502]/10 text-white w-full relative overflow-y-scroll ${selectedUser ? "max-md:hidden" : ""}`}>
